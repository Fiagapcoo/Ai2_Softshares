                ...
                {post && (
                    <div className="post-detail">
                        <div className="post-header">
                            <h2>{post.title}</h2>
                            <p className="text-muted">Posted by {post.Publisher.first_name} {post.Publisher.last_name} ({post.Publisher.email}) on {new Date(post.creation_date).toLocaleString()}</p>
                        </div>
                        ...
                        <div className="post-footer">
                            <p><strong>Sub Area:</strong> {post.SubArea.title}</p>
                            {post.price && <p><strong>Price:</strong> {post.price}</p>}
                            {post.p_location && <p><strong>Location:</strong> {post.p_location}</p>}
                        </div>
                    </div>
                )}
            </div>
